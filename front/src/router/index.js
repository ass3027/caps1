...
const routes = [
  ...
  {path: "/myPage/:type", name: "MyPage", component: MypageView, props: true},
  ...
  {path: "/bsh", name: "bsh", component: testBshView},
  {
    path: "/bsh/:id",
    name: "bshDetail",
    component: TestBshDetailView,
    props: true,
  },
  {
    path: "/placeSupplies",
    name: "placeSupplies",
    component: PlaceSuppliesView,
  },
  ...
  {
    path: "/productBookView",
    name: productBookView,
    component: productBookView,
  },
  {path: "/chart", name: "chart", component: chartView},
...

  {
    ...
    component: DuserOrdersComponent,
  },
  {
  ...
  },
  {
    path: "/GuideProduct",
    name: "GuideProduct",
    component: GuideProduct,
    props: true,
  },
  {
    path: "/GuideProductTime/:gitem_id",
    name: "GuideProductTime",
    component: GuideProductTime,
    props: true,
  },
  {
    path: "/GuideProduct/:gitem_id",
    name: "GuideProductView",
    component: GuideProductView,
    props: true,
  },
  {
    path: "/GuideProduct/Search/:keyword",
    name: "GuideProductSearch",
    component: GuideProductSearch,
    props: true,
  },
  {path: "/GuideIntro/:user_id", name: "GuideIntro", component: GuideIntro},
  {
    path: "/GuideReserveInfo",
    name: "GuideReserveInfo",
    component: GuideReserveInfo,
  },
