  ...
  <div style="clear: both">
    <div id="footer">
      <div class="footer-top">
          ...
          <div class="footer_cc">
            ...
            <div class="cc_view cc_qna">
              <h3>
                <a
                  href="#none"
                  onclick="KurlyTrackerLink('/mypage/inquiry/form', 'select_bottom_onebyone_button')"
                  class="tit"
                >1:1 문의</a>
              </h3>
              <dl class="list">
            ...
            <div class="cc_view cc_bulkorder">
              <h3>
                <a
                  href="/shop/main/html.php?htmid=mypage/bulk_order.htm"
                  class="tit"
                >대량주문 문의</a>
              </h3>
              <p class="txt">
          ...
          <div class="company">
            ...
            >
              <li>
                <a
                  class="link"
                  href="https://www.instagram.com/bong__6"
                >1조 소개</a>
              </li>
              <li>
                <a
            ...
            법인명 (상호) : 주식회사 봉식 <span class="bar">I</span> 사업자등록번호 : 010-934-8972 <a
            ...
            입점문의 : <a
              ...
              target="_blank"
              class="link"
            >입점문의하기</a> <span class="bar">I</span> 마케팅제휴 : <a
              href="https://www.instagram.com/bong__6"
              class="link"
            >www.instagram.com/bong__6</a>
            <br>
            채용문의 : <a
              href="https://www.instagram.com/bong__6"
              class="link"
            >www.instagram.com/bong__6</a>
            <br>
            팩스: 010 - 9934 - 8972 <span class="bar">I</span> 이메일 : <a
              href="https://www.instagram.com/bong__6"
              class="link"
            >www.instagram.com/bong__6</a>
            <br>
            ...
            >
              <li>
                ...
                ><img
                  ...
                  alt="PacklessTravel 인스타그램 바로가기"
                ></a>
              </li>
              <li>
                <a
                  href="https://www.facebook.com/bong__6"
                  class="link_sns"
                  target="_blank"
                ><img
                  src="https://res.kurly.com/pc/ico/1810/ico_fb.png"
                  alt="PacklessTravel 페이스북 바로가기"
                ></a>
              </li>
              <li>
                <a
                  href="http://blog.naver.com/"
                  class="link_sns"
                  target="_blank"
                ><img
                  src="https://res.kurly.com/pc/ico/1810/ico_blog.png"
                  alt="PacklessTravel 네이버블로그 바로가기"
                ></a>
              </li>
              <li>
                <a
        ...
        <div class="footer_link">
          <div class="authentication">
            <a
              href="#none"
              onclick="popup('https://res.kurly.com/kurly/img/2022/isms_220310.png',550,700);return false;"
              class="mark"
              target="_blank"
            >
              <img
            ...
            <a
              href="#none"
              onclick="popup('https://www.eprivacy.or.kr/front/certifiedSiteMark/certifiedSiteMarkPopup.do?certCmd=EP&amp;certNum=2022-EP-R002',527,720);return false;"
              class="mark"
              target="_blank"
            >
              <img
      ...
      <div class="footer_indemnification_clause">
        <p class="txt">
          PacklessTravel 에서 판매되는 상품 중에는 PacklessTravel 에 입점한 개별 판매자가 판매하는 마켓플레이스(오픈마켓) 상품이 포함되어 있습니다.
        </p>
        <p class="txt">
